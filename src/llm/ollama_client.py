...
Message translation:
  Stored format (Anthropic-style)  →  OpenAI/Ollama format
  ──────────────────────────────��──────────────────────────
  user {content: "text"}           →  user {content: "text"}
  ...
  user {content: [{type:tool_result,
                   tool_use_id:..., content:...}]}
                                   →  one tool {tool_call_id:..., content:...}
                                      per result (separate messages)
"""
...
def _to_openai_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Convert stored Anthropic-style messages to OpenAI/Ollama format."""
...
def _to_openai_tools(tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Convert Anthropic tool specs → OpenAI/Ollama tool specs."""
    return [
        {
            "type": "function",
            "function": {
